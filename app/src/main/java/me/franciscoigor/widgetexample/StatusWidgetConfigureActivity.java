 ...
 */
public class StatusWidgetConfigureActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            StatusWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId);
    ...
    public StatusWidgetConfigureActivity() {
        super();
    }
